...
namespace practicum2
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.num1Text.Text = randomNumber.Next(0, 10).ToString();
            // 
            // methodOutput
            // 
            ...
            this.num2Text.Text = randomNumber.Next(0, 10).ToString();
            ...
            this.num3Text.Text = randomNumber.Next(0, 10).ToString();
